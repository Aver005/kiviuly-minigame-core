...
нет шва `Minigame`: вся игра — один класс `GameSession` на **2149 строк** со
service-locator через `EscapePlugin`. Задача — подложить под него общий core, не
потеряв богатые механики. Package root игры: `me.aver005.escape` (можно оставить или
перевести на `ru.kiviuly.escape`).
