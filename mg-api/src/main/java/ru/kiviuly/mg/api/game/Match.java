...
public interface Match
{
    ...
    /**
     * Тихо выбить участника по UUID — БЕЗ broadcast движка (для игр, что сами объявляют
     * смерть) и для ОФФЛАЙН-игрока (когда {@code Player} недоступен). Ставит alive=false,
     * спектейт-режим если игрок онлайн, зовёт хук выбывания и проверяет конец матча.
     */
    void eliminate(UUID id);
